import styles from '../../assets/user/css/Service.module.css'
import delivery from '../../assets/user/img/delivery.png'
import service from '../../assets/user/img/service.png'
import security from '../../assets/user/img/security.png'
